                ...
                <div class="card mt-2">
                    <div class="card-body">
                        ...
                        <?php if (!$tanggalwal && !$tanggakhir) : ?>
                            ...
                            <br><br>
                            <h4 class="text-center mt-2"> Tabel Data Beasiswa Internasional <?= date('d F Y'); ?> </h4>
                        ...
                        <?php else : ?>
                            ...
                            <h4 class="text-center mt-2"> Laporan Daftar Beasiswa Internasional masuk tanggal <?= $tanggalwal . ' s/d' . $tanggakhir ?> </h4>
                        <?php endif; ?>
