...
<meta name="theme-color" content="#563d7c">
  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-black bg-white fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
     ...
     <li class="nav-item">
        <a class="nav-link" href="<?= base_url();?>beasiswan">Beasiswa Nasional</a>
      </li>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url();?>beasiswai">Beasiswa Internasional</a>
      </li>
      </li>
       <li class="nav-item">
